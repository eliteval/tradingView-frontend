        ...
        <div class="row">
            ...
            <div class="col-sm-8" style="border: 3px solid #27a5df;border-radius: 25px;background: #ecf9ff; height: 530px;">
                ...
                <div id="tradingView" class="col-sm-12" style="height: auto;display:none;">
                    <iframe id="tradingView-content" style="height: 500px; margin-top: 20px; border:none;" class="col-sm-12" src="https://tradingview.tradeasy.tech" title="Trading View React"></iframe>
                </div>
